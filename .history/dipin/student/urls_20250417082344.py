...
from .views import course_list, go_to_course_student,attempt_quiz, attempt_exercise,while_quiz, while_exercise,autosave_answer
...
urlpatterns = [
    ...
    path("autosave/", views.autosave_answer, name="autosave_answer"),
