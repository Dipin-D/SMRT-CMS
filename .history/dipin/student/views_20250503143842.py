        ...
        for question in questions:
            ...
            if user_answer != 'n/a':
                if question.type == "multiple_choice":
                    ...
                    print('question.mcq_answer',question.mcq_answers,"user_answer",user_answer)
                elif question.type == "true_false":
...
def autosave_answer_exercise(request):
    ...
    try:
        ...
        if exercise_question.type == "multiple_choice":
            print('selected_answer',selected_answer,"exercise_question.mcq_answer",exercise_question.mcq_answer)
