...
from .views import course_list, go_to_course_student,attempt_quiz, attempt_exercise,while_quiz, while_exercise, save_answer_ajax
...
urlpatterns = [
    ...
    path('ajax/save-answer/', save_answer_ajax, name='save_answer_ajax'),
