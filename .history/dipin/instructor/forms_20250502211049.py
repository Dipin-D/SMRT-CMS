...
class BaseQuestionForm(forms.ModelForm):
    ...
    choice_1 = forms.CharField(max_length=500, widget=forms.Textarea(attrs={'rows': 2, 'class': 'form-control'}))
    choice_2 = forms.CharField(max_length=500, widget=forms.Textarea(attrs={'rows': 2, 'class': 'form-control'}))
    choice_3 = forms.CharField(max_length=500, widget=forms.Textarea(attrs={'rows': 2, 'class': 'form-control'}))
    choice_4 = forms.CharField(max_length=500, widget=forms.Textarea(attrs={'rows': 2, 'class': 'form-control'}))

    # Multiple choice field (checkboxes) to select correct answers
    mcq_answers = forms.MultipleChoiceField(
        choices=[('Choice 1', 'Choice 1'), ('Choice 2', 'Choice 2'), ('Choice 3', 'Choice 3'), ('Choice 4', 'Choice 4')],
    ...
    class Meta:
        model = BaseQuestion
        fields = ['text', 'type', 'choice_1', 'choice_2', 'choice_3', 'choice_4', 'mark', 'mcq_answers', 'tf_answer']
