...
class GoToCourseView(View):
    def get(self, request, class_shell_id):
        ...
        for category, submissions in graded_submissions.items():
            print(f"\nChecking '{category}':")
            for submission in submissions:
                has_attempt_number = hasattr(submission, 'attempt_number')
                print(f" - {submission}: attempt_number exists? {has_attempt_number}")
