    ...
    def post(self, request, class_shell_id, quiz_id):
        ...
        if 'add_question' in request.POST and question_form.is_valid():
            ...
            if question_instance.type == 'multiple_choice':
                print("Cleaned data:", question_form.cleaned_data)  # Debugging line
                ...
                mcq_answers = question_form.cleaned_data.get('mcq_answers', [])
                print("mcq_answers:", mcq_answers)  # Debugging line
                selected_answers = []
                if 'Choice 1' in mcq_answer:
                    selected_answers.append(question_instance.choice_1)
                if 'Choice 2' in mcq_answer:
                    selected_answers.append(question_instance.choice_2)
                if 'Choice 3' in mcq_answer:
                    selected_answers.append(question_instance.choice_3)
                if 'Choice 4' in mcq_answer:
            ...
            if question_instance.type == 'multiple_choice':
                ...
                question_instance.choice_3 = question_form.cleaned_data['choice_3']
                question_instance.choice_4 = question_form.cleaned_data['choice_4']
                question_instance.mcq_answers = question_form.cleaned_data['mcq_answers'] 
            elif question_instance.type == 'true_false':
                question_instance.mcq_answer = None  
...
class ExerciseDetailView(View):
    ...
    def post(self, request, class_shell_id, exercise_id):
        ...
        if exercise_question_instance.type == 'multiple_choice':
            ...
            selected_answers = question_form.cleaned_data['mcq_answers']  
            exercise_question_instance.mcq_answers = selected_answers
