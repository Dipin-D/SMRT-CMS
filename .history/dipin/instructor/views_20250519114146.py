...
class GoToCourseView(View):
   ...
   # analytics section
        ...
        return render(request, 'go_to_course.html', {
            ...
            'grouped_ungraded_assignments': grouped_ungraded_assignments,
            'grouped_ungraded_quizzes': grouped_ungraded_quizzes,            
            'grouped_graded_assignments': grouped_graded_assignments,
            'grouped_graded_quizzes': grouped_graded_quizzes,
       })
