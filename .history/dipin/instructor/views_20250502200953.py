    ...
    def post(self, request, class_shell_id, quiz_id):
        ...
        if 'add_question' in request.POST and question_form.is_valid():
            ...
            if question_instance.type == 'multiple_choice':
                ...
                # Check if selected answers match the choices
                selected_answers = []
                ...
                # Store the selected answers as a JSON string or list
                question_instance.mcq_answer = json.dumps(selected_answers)
