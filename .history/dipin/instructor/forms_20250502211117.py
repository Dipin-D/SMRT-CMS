...
class BaseQuestionForm(forms.ModelForm):
    ...
    choice_1 = forms.CharField(max_length=500, widget=forms.Textarea(attrs={'rows': 1, 'class': 'form-control'}))
    choice_2 = forms.CharField(max_length=500, widget=forms.Textarea(attrs={'rows': 1, 'class': 'form-control'}))
    choice_3 = forms.CharField(max_length=500, widget=forms.Textarea(attrs={'rows': 1, 'class': 'form-control'}))
    choice_4 = forms.CharField(max_length=500, widget=forms.Textarea(attrs={'rows': 1, 'class': 'form-control'}))
