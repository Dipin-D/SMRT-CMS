...
urlpatterns = [
    ...
    # Data ingestion
    path('data-ingestion/', include('pal.data_ingestion.urls')),
    
    # Topic classification
    path('topic-classification/', include('pal.topic_classification.urls')),
    
    # Answer validation endpoint
    path('validate-answer/', views.validate_answer_api, name='validate_answer_api'),
    
    # Knowledge graph
    path('knowledge-graph/', include('pal.knowledge_graph.urls')),
    
    # ML models
    path('ml-models/', include('pal.ml_models.urls')),
    
    # Learning paths
    path('learning-paths/', include('pal.learning_paths.urls')),
