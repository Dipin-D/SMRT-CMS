...
from pal.core.models import Student, Course, Assessment
...
def upload_data(request):
    ...
    if request.method == 'POST':
        if 'file' not in request.FILES:
            ...
            return redirect('data_ingestion:upload_data')
        ...
        return redirect('data_ingestion:upload_detail', upload_id=data_upload.id)    
