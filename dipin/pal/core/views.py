...
from pal.learning_paths.models import TopicResource

def home(request):
    saved_resource_count = Resource.objects.count() + TopicResource.objects.count()
    fallback_resource_count = Topic.objects.count() * 3

    context = {
        'interaction_count': StudentInteraction.objects.count(),
        'question_count': Question.objects.count(),
        'topic_count': Topic.objects.count(),
        'resource_count': max(saved_resource_count, fallback_resource_count),
    }
